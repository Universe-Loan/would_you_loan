...
import com.woorifisa.wl.model.dto.KookminLoanDto;
...
@Entity
@Table(name = "kookmin_loans")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class KookminLoan {
    ...
    public KookminLoanDto toDto() {
        return KookminLoanDto.builder()
                .loanId(this.loanId)
                .userId(this.userId)
